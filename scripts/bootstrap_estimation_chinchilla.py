...
def main():
    ...
    # -------------------------------------------------------------------------
    # Full initialization grid
    # -------------------------------------------------------------------------

    E_log_grid = [-1., -0.5, 0., 0.5, 1.]
    log_A_grid = [0., 5., 10., 20.,]
    log_B_grid = [0., 5., 10., 20.,]
    ...
    results = Parallel(
        ...
        delayed(one_bootstrap_init_chunk)(
            ...
            scaling_law=scaling_law_chinchilla,
    ...
    np.savez(
        "../data/bootstrap/bootstrap_chinchilla.npz",
